...
import uuid
import threading  # 👈 [수정] 스레딩 라이브러리 추가
...
# 👈 [수정] 백그라운드 작업의 상태와 결과를 저장할 인메모리 딕셔너리
tasks = {}
